<?php
namespace Remi\Jobs\Controller\Adminhtml\Department;
...
class Edit extends Action
{
     ...
     * @param \Remi\Jobs\Model\Department $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Remi\Jobs\Model\Department $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Remi_Jobs::department_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Remi_Jobs::department')
